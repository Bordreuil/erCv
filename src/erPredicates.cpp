...
bool IsEqualTo::operator()(int val){return val == get_value();};
IsGreaterThan::IsGreaterThan(int val):CriteriaFunctor(val){};
bool IsGreaterThan::operator()(int val){return val > get_value();};
IsGreaterEqual::IsGreaterEqual(int val):CriteriaFunctor(val){};
bool IsGreaterEqual::operator()(int val){return val>= get_value();};
IsLessThan::IsLessThan(int val):CriteriaFunctor(val){};
bool IsLessThan::operator()(int val){return val < get_value();};
IsLessEqual::IsLessEqual(int val):CriteriaFunctor(val){};
bool IsLessEqual::operator()(int val){return val <=get_value();};
...
bool IsBetween::operator()(int val){return ((val>__lower_value) && (val<__upper_value));};
