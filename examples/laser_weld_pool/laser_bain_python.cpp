...
{ // Zone d interet dans l image retournee
  ...
  erDilatP dil(1); 
  erThresP thr( _THRESH_BINARY, 82, 255); //** <
  CvRect rec_tem;
  ...
  erThresP thr2( _THRESH_BINARY, 88, 255); //** <
  ...
  erThresP thr3( _THRESH_BINARY, 234, 255); //** <
  ...
  erThresP thr4( _THRESH_BINARY, 146, 255); //** <
  ...
  erThresP thr5( _THRESH_BINARY, 160, 255); //** <
